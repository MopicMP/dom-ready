...
> DOM ready and element selectors utility

[![npm version](https://badge.fury.io/js/dom-ready.svg)](https://www.npmjs.com/package/dom-ready)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install dom-ready
```

## Quick Start

```javascript
const { ready } = require('dom-ready');
...
```javascript
const { ready, batch } = require('dom-ready');
